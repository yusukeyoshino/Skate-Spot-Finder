  ...
  return (
    <div className={classes.container}>
      ...
      <p>
        ...
        recorded by POTY and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in POTY. This policy is not applicable to any
      ...
      <p>
        POTY follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of POTY.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on POTY, which are sent directly to
      ...
      <p>
        Note that POTY has no access to or control over these cookies that are
      ...
      <p>
        POTY's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        POTY does not knowingly collect any Personal Identifiable Information
